...
class AppTheme {
  var appTheme = ThemeData(
    primaryColor: BCSNColors.primary,
    primaryColorDark: BCSNColors.primary,
    buttonTheme: const ButtonThemeData(buttonColor: BCSNColors.themeColor),
    canvasColor: BCSNColors.whiteColor,
    hintColor: BCSNColors.hintColor,
